...
function rankedWar() {
  ...
  function countPlayerStatus() {
    ...
    statuses.forEach(function(e) {
      let enemyCount = $('.faction-war .enemy-faction ul.members-list .member.icons [alt*="'+e+'"]').length;
      $('.re_enemy_count .'+e+'Count').text(enemyCount);
  
      let yourCount = $('.faction-war .your-faction ul.members-list .member.icons [alt*="'+e+'"]').length;
