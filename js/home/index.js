...
bsBox.find('ul > li').each( function(i) {
  ...
  let perc = parseInt($(this).find('span.mod-value').text());
...
statsContainer.append(`
  ...
  <div class="re_stats_list">
    ...
    <li tabindex="0" aria-label="Strength: `+stats[0].toLocaleString()+`">
      ...
      <span class="stats" title="`+bonuses[0].toLocaleString()+`">`+stats[0].toLocaleString()+`</span>
    </li>
    ...
    <li tabindex="0" role="row" aria-label="Defense: `+stats[1].toLocaleString()+`">
      ...
      <span class="stats" title="`+bonuses[1].toLocaleString()+`">`+stats[1].toLocaleString()+`</span>
    </li>
    ...
    <li tabindex="0" role="row" aria-label="Speed: `+stats[2].toLocaleString()+`">
      ...
      <span class="stats" title="`+bonuses[2].toLocaleString()+`">`+stats[2].toLocaleString()+`</span>
    </li>
    ...
    <li tabindex="0" role="row" aria-label="Dexterity: `+stats[3].toLocaleString()+`">
      ...
      <span class="stats" title="`+bonuses[3].toLocaleString()+`">`+stats[3].toLocaleString()+`</span>
    </li>
    ...
    <li class="last" tabindex="0" role="row" aria-label="Total: 4,205,666,307">
      ...
      <span class="stats" title="`+bonuses[4].toLocaleString()+`">`+stats[4].toLocaleString()+`</span>
    </li>
